...
import {
  LayoutDashboard, ClipboardCheck, MapPin, FileText,
...
import menuItems from './verifikator/verifikatorMenuItems';
...
export default function IDMAPVerifikatorDashboard() {
  ...
  return (
    <DashboardLayout variant="verifikator" menuItems={menuItems} userName="Verifikator" userRole="Field Officer" placeholder="Cari tugas...">
      <h1 className="text-xl sm:text-2xl font-bold text-mangrove-deep mb-6">Dashboard Verifikator</h1>
