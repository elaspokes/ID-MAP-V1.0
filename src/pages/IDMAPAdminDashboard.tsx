...
import {
  LayoutDashboard, Users, MapPin, TreePine, ClipboardCheck,
  BarChart3, Sprout, Wind, DollarSign,
...
import menuItems from './admin/adminMenuItems';
...
export default function IDMAPAdminDashboard() {
  ...
  return (
    <DashboardLayout variant="admin" menuItems={menuItems} userName="Admin ID-MAP" userRole="Administrator">
      <h1 className="text-xl sm:text-2xl font-bold text-mangrove-deep mb-6">Dashboard Admin</h1>

      {/* Tab nav */}
      <div className="flex gap-2 mb-8 bg-white rounded-xl p-1.5 border border-gray-100 w-fit overflow-x-auto">
        {[
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 focus:border-mangrove-fresh focus:ring-1 focus:ring-mangrove-fresh/30 outline-none w-full sm:w-64"
                />
              </div>
            </div>
